...
require_relative 'mcp/error_handler_factory'
require_relative 'mcp/model'
require_relative 'mcp/base_tool'
require_relative 'mcp/tools/coverage_raw_tool'
require_relative 'mcp/tools/coverage_summary_tool'
require_relative 'mcp/tools/uncovered_lines_tool'
require_relative 'mcp/tools/coverage_detailed_tool'
require_relative 'mcp/tools/all_files_coverage_tool'
require_relative 'mcp/mcp_server'
...
module SimpleCov
  module Mcp
    ...
    def self.run_as_library(argv, error_handler: nil)
      ...
      SimpleCov::Mcp.error_handler = error_handler || ErrorHandlerFactory.for_library
      ...
      SimpleCov::Mcp.error_handler.handle_error(e, context: 'library execution')
