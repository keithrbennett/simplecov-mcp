      ...
      TOOL_GUIDE = [
        {
          ...
          inputs:     ['path (required)', 'root/coverage_file/raise_on_stale (optional)'],
        },
        {
        ...
        },
        {
          ...
          inputs:     ['root/coverage_file (optional)', 'sort_order', 'raise_on_stale', 'tracked_globs',
        ...
        },
        {
          ...
          inputs:     ['root/coverage_file (optional)', 'raise_on_stale', 'tracked_globs'],
        },
        {
          ...
          inputs:     ['code OR file (one required)', 'root/coverage_file/raise_on_stale (optional)'],
        },
        {
          tool:       VersionTool,
