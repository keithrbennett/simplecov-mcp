  ...
  module Tools
    class ListTool < BaseTool
      description <<~DESC
        ...
        Output: JSON {"files": [{"file","covered","total","percentage","stale"}, ...], "counts": {"total", "ok", "stale"}, "skipped_files": [...], "missing_tracked_files": [...], "newer_files": [...], "deleted_files": [...], "length_mismatch_files": [...], "unreadable_files": [...]} sorted as requested. "stale" is a string ('M', 'T', 'L', 'E') or false.
